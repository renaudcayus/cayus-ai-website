...
const ABOUT_TEXT = `Cayus was created by two engineers who grew into senior management and executive roles, then went on to become professional coaches. Long-time friends, our paths kept crossing and so did our shared ambition: to make management better at scale.
...
const TESTIMONIALS = [
    ...
    },
    {
        ...
        review: "Sed do eiusmod tempor incididunt ut labore et dolore."
    },
    {
        name: "Noah Anderson",
    ...
    },
    {
        ...
        review: "Excepteur sint occaecat cupidatat non proident sunt."
    },
    {
        name: "Mia Robinson",
        username: "@miarobinson",
        avatar: "https://randomuser.me/api/portraits/women/12.jpg",
        review: "Culpa qui officia deserunt mollit anim id est laborum."
    },
];
        ...
        <div className="overflow-x-hidden scrollbar-hide size-full">
            ...
            <MaxWidthWrapper className="py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-start gap-4 md:gap-8 py-10">
                    ...
                    <div className="flex flex-col items-start h-min gap-6">
                        {TESTIMONIALS.slice(2, 4).map((review, index) => (
                            <AnimationContainer delay={0.2 * index} key={index}>
                                <MagicCard className="md:p-0">
                                    <Card className="flex flex-col w-full border-none h-min">
                                        <CardHeader className="space-y-0">
                    ...
                    <div className="flex flex-col items-start h-min gap-6">
                        {TESTIMONIALS.slice(4, 6).map((review, index) => (
                            <AnimationContainer delay={0.2 * index} key={index}>
                                <MagicCard className="md:p-0">
                                    <Card className="flex flex-col w-full border-none h-min">
                                        <CardHeader className="space-y-0">
